...
export default {
  ...
  moduleNameMapper: {
    ...
    '^@/core/ui/toaster$': '<rootDir>/tests/__mocks__/@/core/ui/toaster.tsx',
    '^@/core/components/auth/otp-form$': '<rootDir>/tests/__mocks__/@/core/components/auth/otp-form.tsx',
    '^@/core/providers/auth-provider$': '<rootDir>/tests/__mocks__/@/core/providers/auth-provider.tsx',
    '^@/hooks/use-toast$': '<rootDir>/tests/__mocks__/@/hooks/use-toast.ts',
